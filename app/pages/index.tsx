		...
		<div className={styles.cont}>
			<div className={styles.grid}>
				<div className={styles.card}>
					...
					<p>
						Hey, Sia here. <br />
						Nice place, huh? It&apos;s taken quite a few redesigns, and this certainly
						won&apos;t be the last. :3
						<br />
					...
					<ul className={styles.linkItems}>
						...
						<li className={styles.link4}>
							<a
								href="https://steamcommunity.com/profiles/76561199007571171/"
								target="_blank"
								rel="noopener noreferrer"
							>
								Steam
			...
			<footer className={styles.footer}>
				<h3>Everything Under Construction</h3>
			</footer>
		</div>
	)
}
